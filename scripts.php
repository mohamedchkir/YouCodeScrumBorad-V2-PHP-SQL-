...
function getTasks($numeroStatus){
    //CODE HERE
    $requete = "SELECT tasks.id , tasks.title,types.name AS 'typeName',tasks.type_id,priorities.name AS 'priorityName',tasks.priority_id,tasks.status_id,tasks.task_datetime,tasks.description 
